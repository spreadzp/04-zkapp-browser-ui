...
class Membership extends web/* SmartContract */.C3 {
    ...
    async isMember(proof, key) {
        let commitment = this.commitment.get();
        this.commitment.requireEquals(commitment);
        let addressHash = web/* Poseidon */.jm.hash(key.toPublicKey().toFields());
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [MyMerkleWitness, web/* PrivateKey */._q]),
    __metadata("design:returntype", Promise)
...
;// CONCATENATED MODULE: ./src/pages/zkappWorker.ts
...
const functions = {
    ...
    setRoot: async (args)=>{
        debugger;
        const commitment = web/* Field */.gN.fromJSON(JSON.parse(args.commitment));
    ...
    isMember: async (args)=>{
        ...
        const key = web/* PrivateKey */._q.fromJSON(JSON.parse(args.key));
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [674], function() { return __webpack_require__(703); })
...
/******/ 			return "static/chunks/" + "982f5ae2" + "-" + "5472a773fabc9b55" + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
